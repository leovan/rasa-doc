...
## [事件 Event](https://rasa.com/docs/action-server/events) {#event}
...
## [知识库和知识图谱 Knowledge Base / Knowledge Graph](https://rasa.com/docs/action-server/knowledge-bases) {#knowledge-base--knowledge-graph}
